 ...
 *
 * Revised June 9, 2011 - PS. Changed FOSC macro to enable pin 10
 *         See line below - It reads _FOSC(0xC10C); // ...
 *               it used to read     _FOSC(0xC100); // ...
 * 	   this change enables pin 10 to be an I/O pin instead of external oscillator #2.
 */
...
_FOSC(0xC10C); // Required for the clock to operate properly
	       //  see page 697 of the family reference for a description of these bits. 
